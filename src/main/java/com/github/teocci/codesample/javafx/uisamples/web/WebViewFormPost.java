...
public class WebViewFormPost extends Application
{
    ...
    public void start(Stage stage)
    {
        ...
        engine.documentProperty().addListener((ov, oldDoc, doc) -> {
        ...
        engine.getLoadWorker().exceptionProperty().addListener((ov, oldException, exception) -> System.out.println("Load Exception: " + exception));
