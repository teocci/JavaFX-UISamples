...
{
    private final int HOUR_HAND_LENGTH = 50;
    private final int MINUTE_HAND_LENGTH = 75;
    private final int SECOND_HAND_LENGTH = 88;
    private final int SECOND_HAND_OFFSET = 15;
