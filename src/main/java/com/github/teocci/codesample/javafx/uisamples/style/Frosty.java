 ...
 * Based on [Frosted Glass Effect in JavaFX?](https://stackoverflow.com/questions/22622034)
 * <p>
 * Created by teocci.
 *
...
public class Frosty extends Application
{
    ...
    {
        Image backgroundImage = new Image("http://rack.1.mshcdn.com/media/ZgkyMDEzLzA2LzEyLzVhL2lvczczLmIxNGYzLnBuZwpwCXRodW1iCTg1MHg1OTA-CmUJanBn/2c3f63af/e4e/ios7-3.jpg");
    ...
    private void addSlideHandlers(DoubleProperty y, Node content, Scene scene)
    {
        Timeline slideIn = new Timeline(
                new KeyFrame(SLIDE_DURATION, new KeyValue(y, 100))
        );

        slideIn.setOnFinished(e -> content.setVisible(true));

        Timeline slideOut = new Timeline(
                new KeyFrame(SLIDE_DURATION, new KeyValue(y, H))
        );
