...
public class EarthViewer extends Application
{
    ...
    private static final double ROTATE_SECS = 40;
...
//    private static final String SPECULAR_MAP = "http://planetmaker.wthr.us/img/earth_specularmap_flat_8192x4096.jpg";
    ...
    private static final String DIFFUSE_MAP = "/images/Earth.png";
    private static final String NORMAL_MAP = "/images/EarthNormal.png";
    private static final String SPECULAR_MAP = "/images/EarthSpec.png";
